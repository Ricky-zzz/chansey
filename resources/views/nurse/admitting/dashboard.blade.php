...
<div class="flex items-center justify-between mb-4">
    <h2 class="text-2xl font-bold text-slate-800">Bed Availabilities </h2>
</div>
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <div class="text-3xl font-black text-slate-800 mt-1">
                        {{ $data['total'] - $data['available'] }} <span class="text-lg font-normal text-gray-400">/ {{ $data['total'] }}</span>
                    </div>
                    <div class="text-xs text-gray-500 mt-2">{{ $data['available'] }} available</div>
                </div>
