        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <div class="flex gap-2 items-center mt-1 text-sm text-gray-600"">
                    Room: <span class="font-bold text-gray-600">{{ $admission->bed->bed_code }}</span>
                </div>
                <!-- Allergies Alert -->
        ...
        <div class="flex flex-col gap-2 items-end">
            ...
            <div class="flex flex-row gap-2 items-center">
                ...
                <div class="join">
                    ...
                    <button @click="openLogModal(null, null)" class="btn bg-sky-500 hover:bg-sky-400 text-white btn-sm join-item gap-2 border-2 border-sky-600 hover:scale-105 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- NURSING CARE PLAN -->
                    <a href="{{ route('nurse.clinical.care-plan.edit', $admission->id) }}" class="btn bg-emerald-500 hover:bg-emerald-400 text-white btn-sm join-item border-2 border-emerald-600 hover:scale-105 transition-transform">
