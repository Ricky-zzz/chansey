    ...
    <div class="card-enterprise p-5 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                @if($incident->status !== 'resolved')
                    <button class="btn-enterprise-secondary btn-sm" onclick="statusModal.showModal()">
                        Update Status
                    </button>
                @endif
            </div>
...
<dialog id="statusModal" class="modal">
    <div class="modal-box">
        ...
        <form action="{{ route('nurse.headnurse.incident.update-status', $incident) }}" method="POST" class="space-y-4">
...
<style>
    ...
    .badge-enterprise.badge-success {
        @apply bg-emerald-100 text-emerald-800;
    }

    .badge-enterprise.badge-error {
        @apply bg-red-100 text-red-800;
    }

    .badge-enterprise.badge-warning {
        @apply bg-amber-100 text-amber-800;
    }

    .badge-enterprise.badge-info {
    ...
    .btn-enterprise-secondary {
        @apply px-4 py-2 bg-slate-200 text-slate-800 rounded-lg font-medium hover:bg-slate-300 transition-colors flex items-center gap-2;
    }
</style>
