...
<head>
    ...
    <title>Book with Dr. {{ $doctor->last_name }} - Golden Gate Collge</title>
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <a href="{{ route('welcome') }}" class="flex items-center gap-2">
                    ...
                    <h1 class="text-2xl font-bold text-slate-800">Golden Gate Collge</h1>
                </a>
    ...
    <footer class="bg-slate-900 text-slate-300 py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm">
            <p>&copy; {{ date('Y') }} Golden Gate Collge. All rights reserved.</p>
        </div>
    </footer>
